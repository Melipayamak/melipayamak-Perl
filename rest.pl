...
sub SendSMS {
	...
	my $response = $self->{_ua}->post( URL . 'SendSMS', { 
...
sub SendByBaseNumber {
	...
	my $response = $self->{_ua}->post( URL . 'BaseServiceNumber', { 
		'username' => $self->{_username}, 
		'password' => $self->{_password}, 
		'text' => $text,
		'to' => $to,
...
sub GetDeliveries2 {
	...
	my $response = $self->{_ua}->post( URL . 'GetDeliveries2', { 
		'username' => $self->{_username}, 
		'password' => $self->{_password}, 
		'recID' => $recID,
	});
...
sub GetMessages {
	...
	my $response = $self->{_ua}->post( URL . 'GetMessages', { 
		'username' => $self->{_username}, 
		'password' => $self->{_password}, 
		'location' => $location,
		'from' => $from,
...
sub GetCredit {
	...
	my $response = $self->{_ua}->post( URL . 'GetCredit', { 
		'username' => $self->{_username}, 
		'password' => $self->{_password}, 
	});
...
sub GetBasePrice {
	...
	my $response = $self->{_ua}->post( URL . 'GetBasePrice', { 
		'username' => $self->{_username}, 
		'password' => $self->{_password}, 
	});
...
sub GetUserNumbers {
	...
	my $response = $self->{_ua}->post( URL . 'GetUserNumbers', { 
		'username' => $self->{_username}, 
		'password' => $self->{_password}, 
	});
